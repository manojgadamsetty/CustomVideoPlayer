...
open class PlayerCacheMediaConfiguration:NSObject, NSCoding, NSCopying {
    ...
    fileprivate let cacheSegmentQueue = DispatchQueue(label: "com.player.CacheSegmentQueue")
    fileprivate let cacheDownloadInfoQueue = DispatchQueue(label: "com.player.CacheDownloadInfoQueue")
    ...
    public func copy(with zone: NSZone? = nil) -> Any {
        let confi = PlayerCacheMediaConfiguration()
    ...
    public static func configuration(filePath: String) -> PlayerCacheMediaConfiguration {
        ...
        let confi = configuration as! PlayerCacheMediaConfiguration
        confi.filePath = path
        return confi
    }
}
